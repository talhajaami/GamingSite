      ...
      <div className="container">
        <div className="row align-items-center">
          <div className="col-12 col-lg-12 offset-lg-0">
              <h4 className="fadeInUp my-5 text-center" data-aos="fade-down" data-aos-delay="200">A Metaverse built on Polygon and Telos</h4>
          </div>
          <div className="col-lg-6 col-sm-6">
            <img className='about-icons  center-image' data-aos="fade-up" src={Polygon} />
            <h4 className="text-center" data-aos="fade-up">Polygon</h4>
          </div>
          <div className="col-lg-6 col-sm-6">
            <img className='about-icons  center-image' data-aos="fade-up" src={Telos} />
